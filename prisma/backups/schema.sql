...
CREATE TABLE IF NOT EXISTS "public"."tasks" (
    ...
    CONSTRAINT "tasks_status_check" CHECK (("status" = ANY (ARRAY['scheduled'::"text", 'done'::"text", 'rescheduled'::"text"]))),
    CONSTRAINT "tasks_time_check" CHECK (("end_time" > "start_time"))
);
...
CREATE OR REPLACE TRIGGER "set_tasks_updated_at" BEFORE UPDATE ON "public"."tasks" FOR EACH ROW EXECUTE FUNCTION "set_updated_at"();
